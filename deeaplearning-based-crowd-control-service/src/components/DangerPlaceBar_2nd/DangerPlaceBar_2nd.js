    ...
    const fetchData = async () => {
      try {
        ...
        const bars = svg
          ...
          .attr('y', d => y(d.areaName)) // y 위치 설정 (areaName에 따라 결정)
          ...
          .style('fill', (d, i) => { // 막대 색상 설정
            ...
            const index = sortedData.findIndex(item => item.areaName === d.areaName);
        ...
        bars
          ...
          .attr('width', d => x(d.dangerCount)); // 실제 데이터에 따른 너비로 증가 애니메이션
