...
const HeatMap = () => {
  ...
  <div style={{ display: 'flex', alignItems: 'center' }}>
    ...
    <div style={{ marginTop: '50px', marginLeft : '30px'}}>
      <label htmlFor="hour-select" style={{ fontFamily: 'Pretendard', fontWeight: 'regular', fontSize: '16px' }}>시간:</label>
      <select id="hour-select" style={{height: '36px', marginLeft:'10px'}} onChange={handleHourChange}>
      ...
      <label htmlFor="minute-select" style={{marginLeft:'30px', fontFamily: 'Pretendard', fontWeight: 'regular', fontSize: '16px'}}>분:</label>
      <select id="minute-select" style={{height: '36px', marginLeft:'10px'}} onChange={handleMinuteChange}>
